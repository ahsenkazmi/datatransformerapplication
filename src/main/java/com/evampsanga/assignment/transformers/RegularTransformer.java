...
@Slf4j
@Component
public class RegularTransformer implements DataTransformationStrategy {
    @Override
    ...
    public boolean supports(String fieldType) {
        return fieldType.equals("Regular");
    }

    // Other methods in RegularTransformer (validateDataType, formatDate) remain the same as in DataTransformer.
}
